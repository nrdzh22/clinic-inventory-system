                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo '<td class="actions">
                                <a href="admin_edit.php?id=' . $row["id"] . '" class="edit-icon"><img src="pic/edit_icon.png" alt="Edit"></a>
                                <a href="admin_delete.php?id=' . $row["id"] . '" class="delete-icon" onclick="return confirm(\'Are you sure you want to delete this item?\');"><img src="pic/delete_icon.png" alt="Delete"></a>
                                 <a href="admin_add.php?id=' . $row["id"] . '" class="edit-icon"><img src="pic/add_icon.png" alt="Edit"></a>
                              </td>';
                        echo "</tr>";
                    }
                } else {
