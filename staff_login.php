...
<body>
    ...
    <div class="container">
        <section id="content">
            <img src="pic/admin_login.png" alt="Staff Login Image" style="display: block; margin: auto; width: 25%;">
            <h2 align="center"><font face="Times New Roman" color="black">STAFF LOGIN</font></h2>
            <form action="staff_checklogin.php" method="post" align="center">
