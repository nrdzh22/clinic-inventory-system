...
<body>
    ...
    <div class="container">
            <h2 align="center"><font face="Times New Roman" color="black">Staff Registration</font></h2>
            <h2 align="center"><font face="Times New Roman" color="black">Don't have account?Create now.</font></h2>
            <form action="staff_checkregistration.php" method="post" align="center">
                ...
                <p>
                    ...
                    <a href="staff_login.php"><input type="button" value="LOGIN"></a>
                </p>
            </form>
    </div>
